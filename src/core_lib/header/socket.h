...
void _socket_bind(int *socket_fd, int *return_value, struct sockaddr_in *address, char *ip_address,
                  char *port_address);
...
int _socket_accept(int *socket_fd, int *accepted_fd, struct sockaddr_in *address,
