...
enum HTTP_METHOD { HTTP_METHOD_GET, HTTP_METHOD_POST, HTTP_METHOD_HEAD };

enum HTTP_VERSION { HTTP_VERSION_NULL, HTTP_VERSION_1_0, HTTP_VERSION_1_1 };

enum HTTP_CONNECTION { HTTP_CONNECTION_NULL, HTTP_CONNECTION_CLOSE, HTTP_CONNECTION_KEEP_ALIVE };

enum HTTP_CONTENT_TYPE { HTTP_CONTENT_TYPE_NULL, HTTP_CONTENT_TYPE_APPLICATION_URL_ENCODED };

enum HTTP_STATUS { HTTP_STATUS_200, HTTP_STATUS_206, HTTP_STATUS_304 };

enum HTTP_HEADER { HTTP_HEADER_CONTENT_TYPE };

enum http_status_code { HTTP_200, HTTP_206, HTTP_404, HTTP_500 };

enum { HTTP_COOKIE_EXPIRE_FIRST = 0, HTTP_COOKIE_EXPIRE_LAST = 4294967295 };
...
//__attribute__((always_inline))
void _setcookie(struct SYSTEM *System, const char *key, CookieOpt options) {
...
//__attribute__((always_inline))
void _header(struct SYSTEM *System, int header_type, char *val) {
    switch (header_type) {
